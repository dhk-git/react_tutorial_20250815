...
const Leadership: React.FC = () => {
  ...
  return (
    <div className="container max-x-7xl mx-auto px-4 py-32">
      <div className="text-center mb-12">
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
          임원진 소개
        </h1>
        <p className="text-xl text-gray-600">
          혁신과 성장을 이끄는 XXX 의 리더쉽
        </p>
      </div>
      <div className="flex flex-col md:flex-row gap-12 mb-24 items-center">
        <div className="md:w-2/3">
          ...
          <div className="text-lg text-gray-600 space-y-6">
            ...
            <p className="font-semibold mt-8">XXX Company 대표 드림</p>
          </div>
        </div>
        <div className="w-1/3">
          <div className="rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="p-4 bg-white">
              <h3 className="text-xl font-bold text-gray-800">대표대표</h3>
